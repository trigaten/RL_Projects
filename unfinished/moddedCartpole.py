# modded from https://github.com/PacktPublishing/Deep-Reinforcement-Learning-Hands-On-Second-Edition/blob/master/Chapter07/06_cartpole.py
import gym
import ptan
import torch
...
if __name__ == "__main__":
    ...
    exp_source = ptan.experience.ExperienceSourceFirstLast(
        env, agent, gamma=GAMMA, steps_count=NSTEP)
